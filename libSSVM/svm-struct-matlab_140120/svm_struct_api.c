...
#include "coder/constraintCBFnc.h"
#include "coder/constraintCBFnc_types.h"
#include "coder/constraintCBFnc_emxAPI.h"
#include "coder/constraintCBFnc_emxutil.h"
                                               ...
                                               STRUCT_LEARN_PARM *sparm)
{
  ...
  mwSize dims[2] = {1, 1};
  mwSize nFieldName = 3;
  const char* fieldnames[] = {"dimension", "verbose", "globalParams"};
  ...
  */
  ...
  g_struct_T yhat;
  real_T* data;
  const mwSize* featDim;
  double tmp_double;
  int32_T featDim32[3];
  int nPart = sizeof(yi.parts)/sizeof(f_struct_T);
  int i;
  
  /* param */
  param.feat.HoG.SqCellSize = *((real_T*)
          mxGetData(mxGetField(mxGetField(mxGetField(mxGetField(sparm->mex, 0, "globalParams"), 0, "feat"), 0, "HoG"), 0, "SqCellSize")));
  
  /* model */
  mwSize* wSize = mxGetDimensions(mxGetField(model_array, 0, "w"));
  emxInit_real_T(&model.w, 1);
  model.w->data = (real_T*)malloc(sizeof(real_T)*wSize[0]);
  memcpy(model.w->data, mxGetData(mxGetField(model_array, 0, "w")), sizeof(real_T)*wSize[0]);
  model.w->size[0] = wSize[0];
  model.w->allocatedSize = wSize[0];
  
  /* xi */
  xi.featPyr[0].scale = *((real_T*)
          mxGetData(mxGetField(mxGetField(x.mex, 0, "featPyr"), 0, "scale")));
  xi.featPyr[1].scale = *((real_T*)
          mxGetData(mxGetField(mxGetField(x.mex, 0, "featPyr"), 1, "scale")));
  
  data = (real_T*)mxGetData(mxGetField(mxGetField(x.mex, 0, "featPyr"), 0, "feat"));
  featDim = mxGetDimensions(mxGetField(mxGetField(x.mex, 0, "featPyr"), 0, "feat"));
  featDim32[0] = featDim[0];
  featDim32[1] = featDim[1];
  featDim32[2] = featDim[2];
  xi.featPyr[0].feat = emxCreateWrapperND_real_T(data, 3, featDim32);
  
  data = (real_T*)mxGetData(mxGetField(mxGetField(x.mex, 0, "featPyr"), 1, "feat"));
  featDim = mxGetDimensions(mxGetField(mxGetField(x.mex, 0, "featPyr"), 1, "feat"));
  featDim32[0] = featDim[0];
  featDim32[1] = featDim[1];
  featDim32[2] = featDim[2];
  xi.featPyr[1].feat = emxCreateWrapperND_real_T(data, 3, featDim32);
  
  /* yi */
  yi.c = *((real_T*)mxGetData(mxGetField(y.mex, 0, "c")));
  yi.ds = *((real_T*)mxGetData(mxGetField(y.mex, 0, "ds")));
  yi.s = *((real_T*)mxGetData(mxGetField(y.mex, 0, "s")));
  tmp_double = *((double*)mxGetData(mxGetField(y.mex, 0, "appFeatDim")));
  yi.appFeatDim = (int32_T)tmp_double; 
  tmp_double = *((double*)mxGetData(mxGetField(y.mex, 0, "defFeatDim")));
  yi.defFeatDim = (int32_T)tmp_double;
  yi.appScore = *((real_T*)mxGetData(mxGetField(y.mex, 0, "appScore")));
  yi.defScore = *((real_T*)mxGetData(mxGetField(y.mex, 0, "defScore")));
  yi.w_b = *((real_T*)mxGetData(mxGetField(y.mex, 0, "w_b")));
  memcpy(yi.uv, mxGetData(mxGetField(y.mex, 0, "uv")), sizeof(yi.uv));
  memcpy(yi.uv_cc, mxGetData(mxGetField(y.mex, 0, "uv_cc")), sizeof(yi.uv_cc));
  memcpy(yi.wh, mxGetData(mxGetField(y.mex, 0, "wh")), sizeof(yi.wh));
  memcpy(yi.wh_cc, mxGetData(mxGetField(y.mex, 0, "wh_cc")), sizeof(yi.wh_cc));
  memcpy(yi.dudv, mxGetData(mxGetField(y.mex, 0, "dudv")), sizeof(yi.dudv));
  memcpy(yi.dudv_cc, mxGetData(mxGetField(y.mex, 0, "dudv_cc")), sizeof(yi.dudv_cc));
  data = (real_T*)mxGetData(mxGetField(y.mex, 0, "w_app"));
  featDim = mxGetDimensions(mxGetField(y.mex, 0, "w_app"));
  featDim32[0] = featDim[0];
  featDim32[1] = featDim[1];
  yi.w_app = emxCreateWrapperND_real_T(data, 2, featDim32);
   
  /*emxInit_struct_T(&yi.parts, nPart);
   **/
  for(i=0; i<nPart; ++i)
  {
      yi.parts[i].c = *((real_T*)mxGetData(mxGetField(mxGetField(y.mex, 0, "parts"), i, "c")));
      yi.parts[i].ds = *((real_T*)mxGetData(mxGetField(mxGetField(y.mex, 0, "parts"), i, "ds")));
      yi.parts[i].s = *((real_T*)mxGetData(mxGetField(mxGetField(y.mex, 0, "parts"), i, "s")));
      tmp_double = *((double*)mxGetData(mxGetField(mxGetField(y.mex, 0, "parts"), i, "appFeatDim")));
      yi.parts[i].appFeatDim = (int32_T)tmp_double;
      tmp_double = *((double*)mxGetData(mxGetField(mxGetField(y.mex, 0, "parts"), i, "defFeatDim")));
      yi.parts[i].defFeatDim = (int32_T)tmp_double;
      tmp_double = *((double*)mxGetData(mxGetField(mxGetField(y.mex, 0, "parts"), i, "appScore")));
      yi.parts[i].appScore = (int32_T)tmp_double;
      tmp_double = *((double*)mxGetData(mxGetField(mxGetField(y.mex, 0, "parts"), i, "defScore")));
      yi.parts[i].defScore = (int32_T)tmp_double;
      /*yi.parts[i].w_b = *((real_T*)mxGetData(mxGetField(mxGetField(y.mex, 0, "parts"), i, "w_b")));*/
      memcpy(yi.parts[i].uv, mxGetData(mxGetField(mxGetField(y.mex, 0, "parts"), i, "uv")), sizeof(yi.uv));
      memcpy(yi.parts[i].uv_cc, mxGetData(mxGetField(mxGetField(y.mex, 0, "parts"), i, "uv_cc")), sizeof(yi.uv_cc));
      memcpy(yi.parts[i].wh, mxGetData(mxGetField(mxGetField(y.mex, 0, "parts"), i, "wh")), sizeof(yi.wh));
      memcpy(yi.parts[i].wh_cc, mxGetData(mxGetField(mxGetField(y.mex, 0, "parts"), i, "wh_cc")), sizeof(yi.wh_cc));
      memcpy(yi.parts[i].dudv, mxGetData(mxGetField(mxGetField(y.mex, 0, "parts"), i, "dudv")), sizeof(yi.dudv));
      memcpy(yi.parts[i].dudv_cc, mxGetData(mxGetField(mxGetField(y.mex, 0, "parts"), i, "dudv_cc")), sizeof(yi.dudv_cc));
      
      data = (real_T*)mxGetData(mxGetField(mxGetField(y.mex, 0, "parts"), i, "w_app"));
      featDim = mxGetDimensions(mxGetField(mxGetField(y.mex, 0, "parts"), i, "w_app"));
      featDim32[0] = featDim[0];
      featDim32[1] = featDim[1];
      yi.parts[i].w_app = emxCreateWrapperND_real_T(data, 2, featDim32);
      
      data = (real_T*)mxGetData(mxGetField(mxGetField(y.mex, 0, "parts"), i, "w_def"));
      featDim = mxGetDimensions(mxGetField(mxGetField(y.mex, 0, "parts"), i, "w_def"));
      featDim32[0] = featDim[0];
      featDim32[1] = featDim[1];
      yi.parts[i].w_def = emxCreateWrapperND_real_T(data, 2, featDim32);      
  }
    
  /* yhat */
  emxInitStruct_struct_T(&yhat);
  /*
  yhat.w_app = emxCreate_real_T(yi.appFeatDim, 1);
 
  for(i=0; i<nPart; ++i)
  {
      yhat.parts[i].w_app = emxCreate_real_T(yi.parts[i].appFeatDim, 1);
      yhat.parts[i].w_def = emxCreate_real_T(yi.parts[i].defFeatDim, 1);
  }
   **/
  
  /* call */
  constraintCBFnc(&param, &model, &xi, &yi, &yhat);
  ...
  /* yhat */
  const mwSize dims11[2] = {1, 1};
  const mwSize dims21[2] = {2, 1};
  mwSize dimsMN[2];
  const char* fieldnames[] = {"c", "uv", "uv_cc", "wh", "wh_cc", "ds", "s", "dudv", "dudv_cc", "appFeatDim", "defFeatDim", "appScore", "defScore", "parts", "w_app", "w_b"};
  const char* fieldnames_parts[] = {"c", "uv", "uv_cc", "wh", "wh_cc", "ds", "s", "dudv", "dudv_cc", "appFeatDim", "defFeatDim", "appScore", "defScore", "w_app", "w_def"};
  mxArray* tmp;
  ybar.mex = mxCreateStructArray(2, dims11, 16, fieldnames);
    
  tmp = mxCreateNumericArray(2, dims11, mxDOUBLE_CLASS, mxREAL);
  memcpy(mxGetData(tmp), &yhat.c, sizeof(yhat.c));
  mxSetField(ybar.mex, 0, "c", tmp);
  
  tmp = mxCreateNumericArray(2, dims11, mxDOUBLE_CLASS, mxREAL);
  memcpy(mxGetData(tmp), &yhat.ds, sizeof(yhat.ds));
  mxSetField(ybar.mex, 0, "ds", tmp);
  
  tmp = mxCreateNumericArray(2, dims11, mxDOUBLE_CLASS, mxREAL);
  memcpy(mxGetData(tmp), &yhat.s, sizeof(yhat.s));
  mxSetField(ybar.mex, 0, "s", tmp);
  
  tmp = mxCreateNumericArray(2, dims11, mxDOUBLE_CLASS, mxREAL);
  tmp_double = yhat.appFeatDim;
  memcpy(mxGetData(tmp), &tmp_double, sizeof(tmp_double));
  mxSetField(ybar.mex, 0, "appFeatDim", tmp);
  
  tmp = mxCreateNumericArray(2, dims11, mxDOUBLE_CLASS, mxREAL);
  tmp_double = yhat.defFeatDim;
  memcpy(mxGetData(tmp), &tmp_double, sizeof(tmp_double));
  mxSetField(ybar.mex, 0, "defFeatDim", tmp);
  
  tmp = mxCreateNumericArray(2, dims11, mxDOUBLE_CLASS, mxREAL);
  tmp_double = yhat.appScore;
  memcpy(mxGetData(tmp), &tmp_double, sizeof(tmp_double));
  mxSetField(ybar.mex, 0, "appScore", tmp);
  
  tmp = mxCreateNumericArray(2, dims11, mxDOUBLE_CLASS, mxREAL);
  tmp_double = yhat.defScore;
  memcpy(mxGetData(tmp), &tmp_double, sizeof(tmp_double));
  mxSetField(ybar.mex, 0, "defScore", tmp);
  
  tmp = mxCreateNumericArray(2, dims11, mxDOUBLE_CLASS, mxREAL);
  memcpy(mxGetData(tmp), &yhat.w_b, sizeof(yhat.w_b));
  mxSetField(ybar.mex, 0, "w_b", tmp);
 
  tmp = mxCreateNumericArray(2, dims21, mxDOUBLE_CLASS, mxREAL);
  memcpy(mxGetData(tmp), &yhat.uv, sizeof(yhat.uv));
  mxSetField(ybar.mex, 0, "uv", tmp);
    
  tmp = mxCreateNumericArray(2, dims21, mxDOUBLE_CLASS, mxREAL);
  memcpy(mxGetData(tmp), &yhat.uv_cc, sizeof(yhat.uv_cc));
  mxSetField(ybar.mex, 0, "uv_cc", tmp);
  
  tmp = mxCreateNumericArray(2, dims21, mxDOUBLE_CLASS, mxREAL);
  memcpy(mxGetData(tmp), &yhat.wh, sizeof(yhat.wh));
  mxSetField(ybar.mex, 0, "wh", tmp);
  
  tmp = mxCreateNumericArray(2, dims21, mxDOUBLE_CLASS, mxREAL);
  memcpy(mxGetData(tmp), &yhat.wh_cc, sizeof(yhat.wh_cc));
  mxSetField(ybar.mex, 0, "wh_cc", tmp);
  
  tmp = mxCreateNumericArray(2, dims21, mxDOUBLE_CLASS, mxREAL);
  memcpy(mxGetData(tmp), &yhat.dudv, sizeof(yhat.dudv));
  mxSetField(ybar.mex, 0, "dudv", tmp);
  
  tmp = mxCreateNumericArray(2, dims21, mxDOUBLE_CLASS, mxREAL);
  memcpy(mxGetData(tmp), &yhat.dudv_cc, sizeof(yhat.dudv_cc));
  mxSetField(ybar.mex, 0, "dudv_cc", tmp);
  
  dimsMN[0] = yi.appFeatDim;
  dimsMN[1] = 1;
  tmp = mxCreateNumericArray(2, dimsMN, mxDOUBLE_CLASS, mxREAL);
  memcpy(mxGetData(tmp), yhat.w_app->data, sizeof(real_T)*yi.appFeatDim);
  mxSetField(ybar.mex, 0, "w_app", tmp);
  
  dimsMN[0] = nPart;
  dimsMN[1] = 1;
  mxArray* partSt = mxCreateStructArray(2, dimsMN, 15, fieldnames_parts);
  for(i=0; i<nPart; ++i)
  {  
      tmp = mxCreateNumericArray(2, dims11, mxDOUBLE_CLASS, mxREAL);
      memcpy(mxGetData(tmp), &yhat.parts[i].c, sizeof(yhat.c));
      mxSetField(partSt, i, "c", tmp);

      tmp = mxCreateNumericArray(2, dims11, mxDOUBLE_CLASS, mxREAL);
      memcpy(mxGetData(tmp), &yhat.parts[i].ds, sizeof(yhat.ds));
      mxSetField(partSt, i, "ds", tmp);

      tmp = mxCreateNumericArray(2, dims11, mxDOUBLE_CLASS, mxREAL);
      memcpy(mxGetData(tmp), &yhat.parts[i].s, sizeof(yhat.s));
      mxSetField(partSt, i, "s", tmp);

      tmp = mxCreateNumericArray(2, dims11, mxDOUBLE_CLASS, mxREAL);
      tmp_double = yhat.parts[i].appFeatDim;
      memcpy(mxGetData(tmp), &tmp_double, sizeof(tmp_double));
      mxSetField(partSt, i, "appFeatDim", tmp);

      tmp = mxCreateNumericArray(2, dims11, mxDOUBLE_CLASS, mxREAL);
      tmp_double = yhat.parts[i].defFeatDim;
      memcpy(mxGetData(tmp), &tmp_double, sizeof(tmp_double));
      mxSetField(partSt, i, "defFeatDim", tmp);
      
      tmp = mxCreateNumericArray(2, dims11, mxDOUBLE_CLASS, mxREAL);
      tmp_double = yhat.parts[i].appScore;
      memcpy(mxGetData(tmp), &tmp_double, sizeof(tmp_double));
      mxSetField(partSt, i, "appScore", tmp);

      tmp = mxCreateNumericArray(2, dims11, mxDOUBLE_CLASS, mxREAL);
      tmp_double = yhat.parts[i].defScore;
      memcpy(mxGetData(tmp), &tmp_double, sizeof(tmp_double));
      mxSetField(partSt, i, "defScore", tmp);

      /*
      tmp = mxCreateNumericArray(2, dims11, mxDOUBLE_CLASS, mxREAL);
      memcpy(mxGetData(tmp), &yhat.parts[i].w_b, sizeof(yhat.w_b));
      mxSetField(partSt, i, "w_b", tmp);
       **/

      tmp = mxCreateNumericArray(2, dims21, mxDOUBLE_CLASS, mxREAL);
      memcpy(mxGetData(tmp), &yhat.parts[i].uv, sizeof(yhat.uv));
      mxSetField(partSt, i, "uv", tmp);

      tmp = mxCreateNumericArray(2, dims21, mxDOUBLE_CLASS, mxREAL);
      memcpy(mxGetData(tmp), &yhat.parts[i].uv_cc, sizeof(yhat.uv_cc));
      mxSetField(partSt, i, "uv_cc", tmp);

      tmp = mxCreateNumericArray(2, dims21, mxDOUBLE_CLASS, mxREAL);
      memcpy(mxGetData(tmp), &yhat.parts[i].wh, sizeof(yhat.wh));
      mxSetField(partSt, i, "wh", tmp);

      tmp = mxCreateNumericArray(2, dims21, mxDOUBLE_CLASS, mxREAL);
      memcpy(mxGetData(tmp), &yhat.parts[i].wh_cc, sizeof(yhat.wh_cc));
      mxSetField(partSt, i, "wh_cc", tmp);

      tmp = mxCreateNumericArray(2, dims21, mxDOUBLE_CLASS, mxREAL);
      memcpy(mxGetData(tmp), &yhat.parts[i].dudv, sizeof(yhat.dudv));
      mxSetField(partSt, i, "dudv", tmp);

      tmp = mxCreateNumericArray(2, dims21, mxDOUBLE_CLASS, mxREAL);
      memcpy(mxGetData(tmp), &yhat.parts[i].dudv_cc, sizeof(yhat.dudv_cc));
      mxSetField(partSt, i, "dudv_cc", tmp);

      dimsMN[0] = yi.parts[i].appFeatDim;
      dimsMN[1] = 1;
      tmp = mxCreateNumericArray(2, dimsMN, mxDOUBLE_CLASS, mxREAL);
      memcpy(mxGetData(tmp), yhat.parts[i].w_app->data, sizeof(real_T)*yi.parts[i].appFeatDim);
      mxSetField(partSt, i, "w_app", tmp);
  
      dimsMN[0] = yi.parts[i].defFeatDim;
      dimsMN[1] = 1;
      tmp = mxCreateNumericArray(2, dimsMN, mxDOUBLE_CLASS, mxREAL);
      memcpy(mxGetData(tmp), yhat.parts[i].w_def->data, sizeof(real_T)*yi.parts[i].defFeatDim);
      mxSetField(partSt, i, "w_def", tmp);
  }
  mxSetField(ybar.mex, 0, "parts", partSt);
